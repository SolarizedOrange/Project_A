...
public class PlayerStateMove : PlayerStateBase
{
    ...
    {
        PlayerCtrl.MoveCtrl.SetTargetVelocity(Vector3.right * PlayerCtrl.MoveDirection.x * PlayerCtrl.Stat.MoveSpeed.Val);
        ...
        {
            // PlayerCtrl.MoveCtrl.SetTargetRotation(Vector3.right * Math.Sign(PlayerCtrl.MoveDirection.x));
            PlayerCtrl.MoveCtrl.SetTargetRotation(Vector3.right * PlayerCtrl.MoveDirection.x);
    ...
    {
        PlayerCtrl.MoveCtrl.SetTargetVelocity(Vector3.zero);
    }
